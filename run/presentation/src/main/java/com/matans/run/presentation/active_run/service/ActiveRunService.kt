package com.matans.run.presentation.active_run.service
...
import com.matans.run.domain.RunningTracker
...
//we treat it as singelton only one active run
class ActiveRunService: Service() {
    ...
    //shared for all kinds of notifications
    private val baseNotification by lazy {
        NotificationCompat.Builder(applicationContext, CHANNEL_ID)
            .setSmallIcon(com.matans.core.presentation.designsystem.R.drawable.logo)
    ...
    //if the service need to interact with rest of app
