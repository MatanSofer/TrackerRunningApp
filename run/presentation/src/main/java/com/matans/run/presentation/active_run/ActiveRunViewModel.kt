...
import com.matans.run.domain.LocationDataCalculator
...
class ActiveRunViewModel(
    ...
    private val isTrackin = combine(
        shouldTrack,
        hasLocationPermission
    ){ shouldTrack, hasPremission ->
        shouldTrack && hasPremission
    ...
    init {
        ...
        isTrackin
            .onEach {isTrackin ->
                runningTracker.setIsTracking(isTrackin)
            }
            .launchIn(viewModelScope)

        runningTracker.currenLocation
            .onEach {
